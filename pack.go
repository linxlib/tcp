...
func (c *Connection) SendPkg(data []byte, option ...PkgOption) error {
...
func (c *Connection) SendPkgWithTimeout(data []byte, timeout time.Duration, option ...PkgOption) (err error) {
...
func (c *Connection) SendRecvPkg(data []byte, option ...PkgOption) ([]byte, error) {
...
func (c *Connection) SendRecvPkgWithTimeout(data []byte, timeout time.Duration, option ...PkgOption) ([]byte, error) {
	if err := c.SendPkg(data, option...); err == nil {
...
func (c *Connection) RecvPkg(option ...PkgOption) (result []byte, err error) {
	var buffer []byte
	var length int
	pkgOption, err := getPkgOption(option...)
	if err != nil {
...
func (c *Connection) RecvPkgWithTimeout(timeout time.Duration, option ...PkgOption) (data []byte, err error) {
