...
type Server struct {
	...
	handler   ConnHandler  // Connection handler.
...
func NewServer(address string, handler ConnHandler, name ...string) *Server {
	s := &Server{
		address: address,
		handler: handler,
	}
...
// The parameter <name> is optional, which is used to specify the instance name of the server.
func NewServerTLS(address string, tlsConfig *tls.Config, handler ConnHandler, name ...string) *Server {
...
// The parameter <name> is optional, which is used to specify the instance name of the server.
func NewServerKeyCrt(address, crtFile, keyFile string, handler ConnHandler, name ...string) *Server {
	s := NewServer(address, handler, name...)
